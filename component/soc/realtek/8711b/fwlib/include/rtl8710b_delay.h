...
_LONG_CALL_ uint32_t SYSTIMER_TickGet(void);
_LONG_CALL_ uint32_t SYSTIMER_GetPassTime(uint32_t start);
_LONG_CALL_ void DelayUs(uint32_t us);
_LONG_CALL_ void DelayMs(uint32_t ms);
_LONG_CALL_ void DelayNop(uint32_t count);
