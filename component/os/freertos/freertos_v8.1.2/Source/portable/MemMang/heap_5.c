...
#if (CONFIG_ENABLE_RDP == 0)	
		xHeapRegions[ 1 ].xSizeInBytes = (uint8_t*)0x10040000 - (uint8_t*)ucHeap;
#else
		xHeapRegions[ 1 ].xSizeInBytes = (uint8_t*)0x1003F000 - (uint8_t*)ucHeap;
#endif	
#endif		
